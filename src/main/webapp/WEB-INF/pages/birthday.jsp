...
<head>
    ...
    <link rel="icon" href="<%=request.getContextPath() %>/img/cake.jpg" type="image/x-icon"> 
	<link rel="shortcut icon" href="<%=request.getContextPath() %>/img/cake.jpg" type="image/x-icon">
    <title>苗苗生日快乐！</title>
...
<svg id="cake" version="1.1" x="0px" y="0px" width="200px" height="500px" viewBox="0 0 200 500" enable-background="new 0 0 200 500" xml:space="preserve">
    <path fill="#a88679" d="M173.667-13.94c-49.298,0-102.782,0-147.334,0c-3.999,0-4-16.002,0-16.002
        ...
        <animate id="bizcocho_3" attributeName="d" calcMode="spline" keySplines="0 0  1; 0 0 1 1" begin="relleno_2.end" dur="0.3s" fill="freeze" values="
...
<div>
	...
	<br />
	<p id="message">
	2019.10.25，happy birthday，miaomiao!!!<br />
	</p>
</div>
<canvas id="canvas" width="100%" height="200px"></canvas>
</a>
<script>
...
var canvas = document.querySelector('canvas'); //获取body元素
...
<audio autoplay="autoplay" loop="loop" preload="auto" src="<%=request.getContextPath() %>/mp3/ruguomeiyouni.mp3" type="audio/wav"></audio>
